                            ...
                            <div class="col-md-12">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item"><a class="page-link" href="C-hardware.php">5</a></li>
                                        <li class="page-item"><a class="page-link" href="C-services.php">6</a></li>
                                        <li class="page-item"><a class="page-link" href="C-auto-dealers.php">7</a></li>
                                        <li class="page-item">
                                            <a class="page-link" href="C-hardware.php">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div><!-- end col -->
