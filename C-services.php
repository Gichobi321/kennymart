                            ...
                            <div class="col-md-12">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item"><a class="page-link" href="C-auto-dealers.php">7</a></li>
                                        <li class="page-item"><a class="page-link" href="C-retail.php">8</a></li>
                                        <li class="page-item"><a class="page-link" href="C-schools.php">9</a></li>
                                        <li class="page-item">
                                            <a class="page-link" href="C-auto-dealers.php">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div><!-- end col -->
